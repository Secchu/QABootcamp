...
from ConsolePlayer import ConsolePlayer, withinRange
from tictactoePlayer import tictactoePlayer, NotMyTurnError
import unittest
from tictactoeGrid import tictactoeGrid
from tictactoeEnums import playerTurn, gameState
from tictactoeErrors import gridOccupiedError
...
class testPlayers(unittest.TestCase):
    ...
    def testTwoMostDumbestPlayersEver(self):
        ...
        #For our test to work the grid reference has be to passed to r1 and r2's init method by REFERENCE. For players to play against
        #each other they must be playing on the same grid.
        #Objects are usually passed something similar to reference cos passing by value will be too much work ie Lists and large objects.
